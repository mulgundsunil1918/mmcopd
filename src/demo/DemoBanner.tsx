 ...
 * Tells visitors the data is fake and mutations don't persist. No public link
 * back to the source — the repo is private.
 */
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <b>DEMO MODE</b> — read-only showcase of CureDesk HMS. All data is fake (50 patients, 5 doctors, dummy bills + sales).
